...
}, 'easy_deploy.command.deploy' => function (): \EasyCorp\Bundle\EasyDeployBundle\Command\DeployCommand {
    return ($this->privates['easy_deploy.command.deploy'] ?? $this->load('getEasyDeploy_Command_DeployService.php'));
}, 'easy_deploy.command.rollback' => function (): \EasyCorp\Bundle\EasyDeployBundle\Command\RollbackCommand {
    return ($this->privates['easy_deploy.command.rollback'] ?? $this->load('getEasyDeploy_Command_RollbackService.php'));
